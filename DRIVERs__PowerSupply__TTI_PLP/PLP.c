...
/*****************************************************************************
 *  Thurlby-Thandar PLP Series PSU Instrument Driver                               
 *  LabWindows/CVI 5.0 Instrument Driver                                     
 *  Original Release: Thursday, December 19, 2002                                  
 *  By: Product Technology Partners Ltd, www.ptpart.co.uk                              
 *      PH. +44 01954212806   Fax +44 01954212808                              
 *                                                                           
 *  Modification History:                                                    
 *                                                                           
 *       Thursday, December 19, 2002 - Instrument Driver Created.     
 
 		 Tuesday, Decmeber 9th, 2008 - Modified to add Sorensen XEL series by PH at TTi	
		 
		 
		 Monday, March 22nd, 2010 - Modified to add PL-H and XEL-H variants by PH at TTi v1.2
		 						 - Driver now checks for current limit on high and low current ranges
								 - OVP and OCP now set to 105% of instrument maximum
 *                                                                           
 *****************************************************************************/
...
PSUModel_t PSUModel = PL303QMD;
/*****************************************************************************
 *--------------------- Hidden Attribute Declarations -----------------------*
 *****************************************************************************/

#define PLP_ATTR_OPC_TIMEOUT      (IVI_SPECIFIC_PRIVATE_ATTR_BASE + 1L)   /* ViInt32 */
...
#define PLP_IO_SESSION_TYPE   IVI_VAL_VISA_SESSION_TYPE
...
//#define CHANNEL_LIST                            "1, 2"	 //default to one, modified by PLP_IviInt
...
static IviRangeTableEntry attrRangeSettingRangeTableEntries[] =
	{
		{1, 0, 0, "", PLP_VAL_RANGE_2},
		{2, 0, 0, "", PLP_VAL_RANGE_3},
		{IVI_RANGE_TABLE_LAST_ENTRY}
	};
 ...
 *****************************************************************************/
static ViStatus PLP_InitRangeTables (ViSession vi);
static ViStatus PLP_InitAttributes (ViSession vi);
static ViStatus PLP_DefaultInstrSetup (ViSession openInstrSession);
static ViStatus PLP_CheckStatus (ViSession vi);
static ViStatus PLP_WaitForOPC (ViSession vi, ViInt32 maxTime);
static ViStatus PLP_GetDriverSetupOption (ViSession vi,
                                               ViConstString optionTag,
                                               ViInt32 optionValueSize,
                                               ViChar optionValue[]);

    /*- File I/O Utility Functions -*/
static ViStatus PLP_ReadToFile (ViSession vi, ViConstString filename, 
                                     ViInt32 maxBytesToRead, ViInt32 fileAction, ViInt32 *totalBytesWritten);
static ViStatus PLP_WriteFromFile (ViSession vi, ViConstString filename, 
...
static ViStatus _VI_FUNC PLP_CheckStatusCallback (ViSession vi, ViSession io);
static ViStatus _VI_FUNC PLP_WaitForOPCCallback (ViSession vi, ViSession io);

    /*- Attribute callbacks -------------------------------------------------*/

static ViStatus _VI_FUNC PLPAttrDriverRevision_ReadCallback (ViSession vi,
                                                                  ViSession io, 
                                                                  ViConstString channelName,
                                                                  ViAttr attributeId, 
                                                                  const ViConstString cacheValue);
static ViStatus _VI_FUNC PLPAttrInstrumentManufacturer_ReadCallback (ViSession vi, 
                                                                          ViSession io,
                                                                          ViConstString channelName, 
                                                                          ViAttr attributeId,
                                                                          const ViConstString cacheValue);
static ViStatus _VI_FUNC PLPAttrInstrumentModel_ReadCallback (ViSession vi, 
                                                                   ViSession io,
                                                                   ViConstString channelName, 
                                                                   ViAttr attributeId,
                                                                   const ViConstString cacheValue);

static ViStatus _VI_FUNC PLPAttrIdQueryResponse_ReadCallback (ViSession vi,
                                                                   ViSession io, 
                                                                   ViConstString channelName, 
                                                                   ViAttr attributeId, 
                                                                   const ViConstString cacheValue);
static ViStatus _VI_FUNC PLPAttrOutputEnabled_WriteCallback (ViSession vi, 
                                                                 ViSession io,
                                                                 ViConstString channelName, 
                                                                 ViAttr attributeId,
                                                                 ViBoolean value);
static ViStatus _VI_FUNC PLPAttrVoltageLevel_WriteCallback (ViSession vi, 
                                                                ViSession io,
                                                                ViConstString channelName, 
                                                                ViAttr attributeId,
                                                                ViReal64 value);
static ViStatus _VI_FUNC PLPAttrVoltageLevel_ReadCallback (ViSession vi, 
                                                               ViSession io,
                                                               ViConstString channelName, 
                                                               ViAttr attributeId,
                                                               ViReal64* value);
static ViStatus _VI_FUNC PLPAttrOVPLimit_WriteCallback (ViSession vi, 
                                                            ViSession io,
                                                            ViConstString channelName, 
                                                            ViAttr attributeId,
                                                            ViReal64 value);
static ViStatus _VI_FUNC PLPAttrOVPLimit_ReadCallback (ViSession vi, 
                                                           ViSession io,
                                                           ViConstString channelName, 
                                                           ViAttr attributeId,
                                                           ViReal64* value);
static ViStatus _VI_FUNC PLPAttrCurrentLimit_WriteCallback (ViSession vi, 
                                                                ViSession io,
                                                                ViConstString channelName, 
                                                                ViAttr attributeId,
                                                                ViReal64 value);
static ViStatus _VI_FUNC PLPAttrCurrentLimit_ReadCallback (ViSession vi, 
                                                               ViSession io,
                                                               ViConstString channelName, 
                                                               ViAttr attributeId,
                                                               ViReal64* value);

static ViStatus _VI_FUNC PLPAttrRangeSetting_ReadCallback (ViSession vi,
                                                            ViSession io,
                                                            ViConstString channelName,
                                                            ViAttr attributeId,
                                                            ViInt32 *value);

static ViStatus _VI_FUNC PLPAttrRangeSetting_WriteCallback (ViSession vi,
                                                             ViSession io,
                                                             ViConstString channelName,
                                                             ViAttr attributeId,
                                                             ViInt32 value);

static ViStatus _VI_FUNC PLPAttrOCPLimit_ReadCallback (ViSession vi,
                                                        ViSession io,
                                                        ViConstString channelName,
                                                        ViAttr attributeId,
                                                        ViReal64 *value);

static ViStatus _VI_FUNC PLPAttrOCPLimit_WriteCallback (ViSession vi,
                                                         ViSession io,
                                                         ViConstString channelName,
                                                         ViAttr attributeId,
                                                         ViReal64 value);

static ViStatus _VI_FUNC PLPAttrIflock_ReadCallback (ViSession vi, ViSession io,
                                                     ViConstString channelName,
                                                     ViAttr attributeId,
                                                     ViBoolean *value);

static ViStatus _VI_FUNC PLPAttrIflock_WriteCallback (ViSession vi, ViSession io,
                                                      ViConstString channelName,
                                                      ViAttr attributeId,
                                                      ViBoolean value);

static ViStatus _VI_FUNC PLPAttrVoltageStepSize_ReadCallback (ViSession vi,
                                                               ViSession io,
                                                               ViConstString channelName,
                                                               ViAttr attributeId,
                                                               ViReal64 *value);

static ViStatus _VI_FUNC PLPAttrVoltageStepSize_WriteCallback (ViSession vi,
                                                                ViSession io,
                                                                ViConstString channelName,
                                                                ViAttr attributeId,
                                                                ViReal64 value);

static ViStatus _VI_FUNC PLPAttrCurrentStepSize_ReadCallback (ViSession vi,
                                                               ViSession io,
                                                               ViConstString channelName,
                                                               ViAttr attributeId,
                                                               ViReal64 *value);

static ViStatus _VI_FUNC PLPAttrCurrentStepSize_WriteCallback (ViSession vi,
                                                                ViSession io,
                                                                ViConstString channelName,
                                                                ViAttr attributeId,
                                                                ViReal64 value);
...
static ViStatus _VI_FUNC PLPAttrLimitStatusRegister1_ReadCallback (ViSession vi,
                                                                    ViSession io,
                                                                    ViConstString channelName,
                                                                    ViAttr attributeId,
                                                                    ViInt32 *value);

static ViStatus _VI_FUNC PLPAttrLimitStatusEnableRegister1_ReadCallback (ViSession vi,
                                                                          ViSession io,
                                                                          ViConstString channelName,
                                                                          ViAttr attributeId,
                                                                          ViInt32 *value);

static ViStatus _VI_FUNC PLPAttrLimitStatusEnableRegister1_WriteCallback (ViSession vi,
                                                                           ViSession io,
                                                                           ViConstString channelName,
                                                                           ViAttr attributeId,
                                                                           ViInt32 value);

static ViStatus _VI_FUNC PLPAttrStandardEventEnableRegister_ReadCallback (ViSession vi,
                                                                           ViSession io,
                                                                           ViConstString channelName,
                                                                           ViAttr attributeId,
                                                                           ViInt32 *value);

static ViStatus _VI_FUNC PLPAttrStandardEventEnableRegister_WriteCallback (ViSession vi,
                                                                            ViSession io,
                                                                            ViConstString channelName,
                                                                            ViAttr attributeId,
                                                                            ViInt32 value);

static ViStatus _VI_FUNC PLPAttrIstLocalMessage_ReadCallback (ViSession vi,
                                                               ViSession io,
                                                               ViConstString channelName,
                                                               ViAttr attributeId,
                                                               ViInt32 *value);

static ViStatus _VI_FUNC PLPAttrStandardEventStatusRegister_ReadCallback (ViSession vi,
                                                                           ViSession io,
                                                                           ViConstString channelName,
                                                                           ViAttr attributeId,
                                                                           ViInt32 *value);

static ViStatus _VI_FUNC PLPAttrOperationCompleteStatus_ReadCallback (ViSession vi,
                                                                       ViSession io,
                                                                       ViConstString channelName,
                                                                       ViAttr attributeId,
                                                                       ViInt32 *value);

static ViStatus _VI_FUNC PLPAttrOperationCompleteStatus_WriteCallback (ViSession vi,
                                                                        ViSession io,
                                                                        ViConstString channelName,
                                                                        ViAttr attributeId,
                                                                        ViInt32 value);

static ViStatus _VI_FUNC PLPAttrParallelPoleEnableRegister_ReadCallback (ViSession vi,
                                                                          ViSession io,
                                                                          ViConstString channelName,
                                                                          ViAttr attributeId,
                                                                          ViInt32 *value);

static ViStatus _VI_FUNC PLPAttrParallelPoleEnableRegister_WriteCallback (ViSession vi,
                                                                           ViSession io,
                                                                           ViConstString channelName,
                                                                           ViAttr attributeId,
                                                                           ViInt32 value);

static ViStatus _VI_FUNC PLPAttrServiceRequestEnableRegister_ReadCallback (ViSession vi,
                                                                            ViSession io,
                                                                            ViConstString channelName,
                                                                            ViAttr attributeId,
                                                                            ViInt32 *value);

static ViStatus _VI_FUNC PLPAttrServiceRequestEnableRegister_WriteCallback (ViSession vi,
                                                                             ViSession io,
                                                                             ViConstString channelName,
                                                                             ViAttr attributeId,
                                                                             ViInt32 value);

static ViStatus _VI_FUNC PLPAttrStatusByteRegister_ReadCallback (ViSession vi,
                                                                  ViSession io,
                                                                  ViConstString channelName,
                                                                  ViAttr attributeId,
                                                                  ViInt32 *value);

static ViStatus _VI_FUNC PLPAttrAddress_ReadCallback (ViSession vi,
                                                       ViSession io,
                                                       ViConstString channelName,
                                                       ViAttr attributeId,
                                                       ViInt32 *value);

static ViStatus _VI_FUNC PLPAttrVerifyVoltage_ReadCallback (ViSession vi,
                                                             ViSession io,
                                                             ViConstString channelName,
                                                             ViAttr attributeId,
                                                             ViBoolean *value);

static ViStatus _VI_FUNC PLPAttrVerifyVoltage_WriteCallback (ViSession vi,
                                                              ViSession io,
                                                              ViConstString channelName,
                                                              ViAttr attributeId,
                                                              ViBoolean value);

static ViStatus _VI_FUNC PLPAttrOutputEnabledAll_WriteCallback (ViSession vi,
                                                                 ViSession io,
                                                                 ViConstString channelName,
                                                                 ViAttr attributeId,
                                                                 ViBoolean value);
...
static ViStatus _VI_FUNC PLPAttrLimitStatusRegister2_ReadCallback (ViSession vi,
                                                                    ViSession io,
                                                                    ViConstString channelName,
                                                                    ViAttr attributeId,
                                                                    ViInt32 *value);

static ViStatus _VI_FUNC PLPAttrLimitStatusEnableRegister2_ReadCallback (ViSession vi,
                                                                          ViSession io,
                                                                          ViConstString channelName,
                                                                          ViAttr attributeId,
                                                                          ViInt32 *value);

static ViStatus _VI_FUNC PLPAttrLimitStatusEnableRegister2_WriteCallback (ViSession vi,
                                                                           ViSession io,
                                                                           ViConstString channelName,
                                                                           ViAttr attributeId,
                                                                           ViInt32 value);

static ViStatus _VI_FUNC PLPAttrConfig_ReadCallback (ViSession vi, ViSession io,
                                                     ViConstString channelName,
                                                     ViAttr attributeId,
                                                     ViInt32 *value);

static ViStatus _VI_FUNC PLPAttrDamping_WriteCallback (ViSession vi,
                                                       ViSession io,
                                                       ViConstString channelName,
                                                       ViAttr attributeId,
                                                       ViBoolean value);

static ViStatus _VI_FUNC PLPAttrRatio_ReadCallback (ViSession vi, ViSession io,
                                                    ViConstString channelName,
                                                    ViAttr attributeId,
                                                    ViReal64 *value);

static ViStatus _VI_FUNC PLPAttrRatio_WriteCallback (ViSession vi, ViSession io,
                                                     ViConstString channelName,
                                                     ViAttr attributeId,
                                                     ViReal64 value);
...
{   
	...
	checkErr( PLP_InitWithOptions (resourceName, IDQuery, resetDevice, 
	                                "", newVi));
...
{   
	...
	*newVi = VI_NULL;
	...
	checkErr( Ivi_SpecificDriverNew ("PLP", newOptionString, &vi));  

	/* init the driver */
	checkErr( PLP_IviInit (newResourceName, IDQuery, resetDevice, vi)); 
	if (isLogicalName)
...
/*****************************************************************************
 * Function: PLP_IviInit                                                       
 * Purpose:  This function is called by PLP_InitWithOptions  
 ...
 *
 *****************************************************************************/
ViStatus _VI_FUNC PLP_IviInit (ViRsrc resourceName, ViBoolean IDQuery, ViBoolean reset, ViSession vi)
{
	ViStatus    error = VI_SUCCESS;
	...
	/* Add attributes */
	checkErr( PLP_InitAttributes (vi));
	...
	/*- Reset instrument ----------------------------------------------------*/
	if (reset) 
		checkErr( PLP_reset (vi));
	else  /*- Send Default Instrument Setup ---------------------------------*/
		checkErr( PLP_DefaultInstrSetup (vi));

	/*- Identification Query ------------------------------------------------*/
	if (IDQuery)                               
	{
		#define MUST_HAVE_IN_RESPONSE_STRING_1		 "THURLBY THANDAR"
		#define MUST_HAVE_IN_RESPONSE_STRING_2		 "PL"
		#define MUST_HAVE_IN_RESPONSE_STRING_1a		 "SORENSEN"
		#define MUST_HAVE_IN_RESPONSE_STRING_2a		 "XEL"

		checkErr( Ivi_GetAttributeViString (vi, VI_NULL, PLP_ATTR_ID_QUERY_RESPONSE, 0, BUFFER_SIZE, rdBuffer));
		...
		//configure the model
		if (strstr (rdBuffer, "PL155-P") != NULL)
			PSUModel = PL155;
		else if (strstr (rdBuffer, "PL303-P") != NULL)
			PSUModel = PL303;
		else if (strstr (rdBuffer, "PL601-P") != NULL)
			PSUModel = PL601;
		else if (strstr (rdBuffer, "XEL 30-3DP") != NULL)     
			PSUModel = XEL303DP;
				
		else if (strstr (rdBuffer, "XEL 30-3P") != NULL)     
			PSUModel = XEL303P;
				
		else if (strstr (rdBuffer, "XEL 15-5DP") != NULL)     
			PSUModel = XEL155P;
				
		else if (strstr (rdBuffer, "XEL 60-1.5P") != NULL)     
			PSUModel = XEL601P;
		
		else if (strstr (rdBuffer, "PLH120-P") != NULL)     
			PSUModel = PLH120P;
		
		else if (strstr (rdBuffer, "PLH250-P") != NULL)     
			PSUModel = PLH250P;
		
		else if (strstr (rdBuffer, "XEL 120-075P") != NULL)     
			PSUModel = XEL120_075P;
		
		else if (strstr (rdBuffer, "XEL 250-037P") != NULL)     
			PSUModel = XEL250_037P;
		...
		checkErr( Ivi_GetAttributeViString (vi, VI_NULL, PLP_ATTR_INSTRUMENT_MODEL, 0, BUFFER_SIZE, rdBuffer));
	}

	//setup range tables with model specific information
	checkErr( PLP_InitRangeTables (vi));
	
	checkErr( PLP_CheckStatus (vi));
 ...
 *           PLP_close or by an IVI class driver. 
 *
...
/*****************************************************************************
 * Function: PLP_WaitForOperationComplete  
 ...
 *
 *****************************************************************************/
ViStatus _VI_FUNC PLP_self_test (ViSession vi, ViInt16 *testResult, 
                                      ViChar testMessage[])
{
	ViStatus    error = VI_SUCCESS;
...
/*****************************************************************************
 * Function: PLP_query_error_query                                                     
 ...
 *
 *****************************************************************************/
ViStatus _VI_FUNC PLP_error_query (ViSession vi, ViInt32 *errCode, 
                                        ViChar errMessage[])
{
	ViStatus    error = VI_SUCCESS;
...
/*****************************************************************************
 * Function: PLP_execution_error_query                                                     
 ...
 *
 *****************************************************************************/
ViStatus _VI_FUNC PLP_execution_error_query (ViSession vi, ViInt32 *errCode, 
                                        ViChar errMessage[])
{
	ViStatus    error = VI_SUCCESS;
                                          ...
                                          ViChar errorMessage[256])
{
	...
	static      IviStringValueTable errorTable = 
	{
		/*=PTP KCS================================================================*
		    ...
		    {PLP_ERROR_TOO_MANY_SAMPLES,   "Sample Count cannot exceed 512."},   
		 *=============================================================END=PTP KCS*/
 ...
 *
 *****************************************************************************/
ViStatus _VI_FUNC PLP_revision_query (ViSession vi, ViChar driverRev[], 
                                           ViChar instrRev[])
{
  ViStatus    error = VI_SUCCESS;
  ...
  checkErr( Ivi_GetAttributeViString (vi, VI_NULL, PLP_ATTR_SPECIFIC_DRIVER_REVISION, 
                                      0, 256, driverRev));
  checkErr( Ivi_GetAttributeViString (vi, "", PLP_ATTR_INSTRUMENT_FIRMWARE_REVISION, 
                                      0, 256, instrRev));
  checkErr( PLP_CheckStatus (vi));
...
/*****************************************************************************
 * Function: PLP_ConfigureOutputEnabled                                   
                                                   ...
                                                   ViBoolean enabled)
{
	...
	error = Ivi_SetAttributeViBoolean (vi, channelName, PLP_ATTR_OUTPUT_ENABLED,
...
/*****************************************************************************
 * Function: PLP_ConfigureCurrentLimit                                   
                                              ...
                                              ViReal64 limit)
{
	...
	this is wrong, you haven't locked it! Ivi_UnlockSession(vi, VI_NULL);
	...
	*/
	...
	checkErr(Ivi_GetAttributeViInt32 (vi, channelName, PLP_ATTR_RANGE_SETTING,
                                       0, &range));
	
	
	
	
	if (behavior == PLP_VAL_CURRENT_REGULATE || behavior == PLP_VAL_CURRENT_TRIP)
	{
		...
		case 1:	
			error = Ivi_SetAttributeViReal64 (vi, channelName, PLP_ATTR_CURRENT_LIMIT, 1, limit);			/* Kevin's code didn't have 'error =' so an over range value failed to raise status error */ 
			break;
		case 2:
			error = Ivi_SetAttributeViReal64 (vi, channelName, PLP_ATTR_CURRENT_LIMIT, 0, limit);			/* Kevin's code didn't have 'error =' so an over range value failed to raise status error */     
			break;
...
/*****************************************************************************
 * Function: PLP_ConfigureVoltageLevel                                   
                                                  ...
                                                  ViReal64 level)
{
	...
	error = Ivi_SetAttributeViReal64 (vi, channelName, PLP_ATTR_VOLTAGE_LEVEL,
...
/*****************************************************************************
 * Function: PLP_QueryMaxCurrentLimit                  
 	  ...
 	  switch (PSUModel)
		{
			...
			case PL303:
			case XEL303P: 		
				value = 3.0;				 /* this was 30.0 in original driver from Kevin !   */
				break;
			case PL601:
			case XEL601P:  	
				value = 1.5;
...
/*****************************************************************************
 * Function: PLP_QueryMaxVoltageLevel                  
...
/*****************************************************************************
 * Function: PLP_ResetOutputProtection                                   
...
/*****************************************************************************
 * Function: PLP_IncrementVoltageLevel
...
/*****************************************************************************
 * Function: PLP_DecrementVoltageLevel
...
/*****************************************************************************
 * Function: PLP_IncrementCurrentLevel
...
/*****************************************************************************
 * Function: PLP_DecrementCurrentLevel
...
{
	{PLP_VAL_MEASURE_CURRENT, 0, 0, "I", PLP_ATTR_CURRENT_LIMIT},
	{PLP_VAL_MEASURE_VOLTAGE, 0, 0, "V", PLP_ATTR_VOLTAGE_LEVEL},
	{IVI_RANGE_TABLE_LAST_ENTRY}
};
...
/*****************************************************************************
 * Function: PLP_GetAttribute<type> Functions                                    
 ...
 *
 *****************************************************************************/
ViStatus _VI_FUNC PLP_GetAttributeViInt32 (ViSession vi, ViConstString channelName, 
                                                ViAttr attributeId, ViInt32 *value)
{                                                                                                           
    return Ivi_GetAttributeViInt32 (vi, channelName, attributeId, IVI_VAL_DIRECT_USER_CALL, 
                                    value);
}                                                                                                           
ViStatus _VI_FUNC PLP_GetAttributeViReal64 (ViSession vi, ViConstString channelName, 
                                                 ViAttr attributeId, ViReal64 *value)
{                                                                                                           
    return Ivi_GetAttributeViReal64 (vi, channelName, attributeId, IVI_VAL_DIRECT_USER_CALL, 
                                     value);
}                                                                                                           
ViStatus _VI_FUNC PLP_GetAttributeViString (ViSession vi, ViConstString channelName, 
...
ViStatus _VI_FUNC PLP_GetAttributeViBoolean (ViSession vi, ViConstString channelName, 
                                                  ViAttr attributeId, ViBoolean *value)
{                                                                                                           
    return Ivi_GetAttributeViBoolean (vi, channelName, attributeId, IVI_VAL_DIRECT_USER_CALL, 
                                      value);
}                                                                                                           
ViStatus _VI_FUNC PLP_GetAttributeViSession (ViSession vi, ViConstString channelName, 
...
/*****************************************************************************
 * Function: PLP_SetAttribute<type> Functions                                    
 ...
 *
 *****************************************************************************/
ViStatus _VI_FUNC PLP_SetAttributeViInt32 (ViSession vi, ViConstString channelName, 
                                                ViAttr attributeId, ViInt32 value)
{                                                                                                           
    return Ivi_SetAttributeViInt32 (vi, channelName, attributeId, IVI_VAL_DIRECT_USER_CALL, 
                                    value);
}                                                                                                           
ViStatus _VI_FUNC PLP_SetAttributeViReal64 (ViSession vi, ViConstString channelName, 
                                                 ViAttr attributeId, ViReal64 value)
{                                                                                                           
    return Ivi_SetAttributeViReal64 (vi, channelName, attributeId, IVI_VAL_DIRECT_USER_CALL, 
                                     value);
}                                                                                                           
ViStatus _VI_FUNC PLP_SetAttributeViString (ViSession vi, ViConstString channelName, 
...
ViStatus _VI_FUNC PLP_SetAttributeViBoolean (ViSession vi, ViConstString channelName, 
                                                  ViAttr attributeId, ViBoolean value)
{                                                                                                           
    return Ivi_SetAttributeViBoolean (vi, channelName, attributeId, IVI_VAL_DIRECT_USER_CALL, 
                                      value);
}                                                                                                           
ViStatus _VI_FUNC PLP_SetAttributeViSession (ViSession vi, ViConstString channelName, 
                                                  ViAttr attributeId, ViSession value)
{                                                                                                           
...
/*****************************************************************************
 * Function: PLP_CheckAttribute<type> Functions                                  
 ...
 *           specify even if you set the PLP_ATTR_RANGE_CHECK 
 ...
 *
 *****************************************************************************/
ViStatus _VI_FUNC PLP_CheckAttributeViInt32 (ViSession vi, ViConstString channelName, 
                                                  ViAttr attributeId, ViInt32 value)
{                                                                                                           
    return Ivi_CheckAttributeViInt32 (vi, channelName, attributeId, IVI_VAL_DIRECT_USER_CALL, 
                                      value);
}
ViStatus _VI_FUNC PLP_CheckAttributeViReal64 (ViSession vi, ViConstString channelName, 
                                                   ViAttr attributeId, ViReal64 value)
{                                                                                                           
    return Ivi_CheckAttributeViReal64 (vi, channelName, attributeId, IVI_VAL_DIRECT_USER_CALL, 
                                       value);
}                                                                                                           
ViStatus _VI_FUNC PLP_CheckAttributeViString (ViSession vi, ViConstString channelName, 
                                                   ViAttr attributeId, ViConstString value)  
{   
    return Ivi_CheckAttributeViString (vi, channelName, attributeId, IVI_VAL_DIRECT_USER_CALL, 
                                       value);
}   
ViStatus _VI_FUNC PLP_CheckAttributeViBoolean (ViSession vi, ViConstString channelName, 
                                                    ViAttr attributeId, ViBoolean value)
{                                                                                                           
    return Ivi_CheckAttributeViBoolean (vi, channelName, attributeId, IVI_VAL_DIRECT_USER_CALL, 
                                        value);
}                                                                                                           
ViStatus _VI_FUNC PLP_CheckAttributeViSession (ViSession vi, ViConstString channelName, 
                                                    ViAttr attributeId, ViSession value)
{                                                                                                           
...
/*****************************************************************************
 * Function: PLP_GetNextCoercionRecord                        
...
/*****************************************************************************
 * Function: PLP_LockSession and PLP_UnlockSession Functions                        
...
/*****************************************************************************
 * Function: PLP_GetErrorInfo and PLP_ClearErrorInfo Functions                       
...
/*------------[NEW]----------------------------------------------------------*/
/*****************************************************************************
 * Function: PLP_InvalidateAllAttributes
...
/*****************************************************************************
 * Function: PLP_ResetWithDefaults
...
ViStatus _VI_FUNC PLP_Disable (ViSession vi)
{
	...
	error = Ivi_SetAttributeViBoolean (vi, VI_NULL, PLP_ATTR_OUTPUT_ENABLED_ALL,
...
/**************************************************************************** 
 *  Function: PLP_GetNextInterchangeWarning,
 *            PLP_ResetInterchangeCheck, and
 *            PLP_ClearInterchangeWarnings
...
/*****************************************************************************
 * Function: PLP_ResetInterchangeCheck                                       
 * Purpose:                                       
 *
 *	Copyright (c) 2008 Product Technology Partners
 *
...
/*****************************************************************************
 * Function: PLP_ClearInterchangeWarnings                                       
 * Purpose:                                       
 *
 *	Copyright (c) 2008 Product Technology Partners
 *
...
/*****************************************************************************
 * Function: PLP_ConfigureOutputRange                                       
                                                 ...
                                                 ViReal64 range)
{
  ViStatus error = VI_SUCCESS;
	...
	if (rangeType == PLP_VAL_RANGE_CURRENT || rangeType == PLP_VAL_RANGE_VOLTAGE)
	{	
		error = Ivi_SetAttributeViInt32 (vi, channelName, PLP_ATTR_RANGE_SETTING,
                                             ...
                                             ViBoolean* inState)
{
   ViStatus error = VI_SUCCESS;
	...
	switch (outputState)
	{
		case PLP_VAL_OUTPUT_CONSTANT_VOLTAGE:
		case PLP_VAL_OUTPUT_CONSTANT_CURRENT:
		case PLP_VAL_OUTPUT_OVER_VOLTAGE:
		case PLP_VAL_OUTPUT_OVER_CURRENT:    
		case PLP_VAL_OUTPUT_UNREGULATED:     
...
static ViStatus PLP_CheckStatus (ViSession vi)
{
  ...
  {
	  checkErr( PLP_CheckStatusCallback (vi, Ivi_IOSession(vi)));
...
static ViStatus PLP_WaitForOPC (ViSession vi, ViInt32 maxTime) 
{
  ...
  if (!Ivi_Simulating(vi))
  {
	  ...
	  checkErr( Ivi_GetAttributeViInt32 (vi, VI_NULL, PLP_ATTR_OPC_TIMEOUT, 
	                                     0, &oldOPCTimeout));
	  Ivi_SetAttributeViInt32 (vi, VI_NULL, PLP_ATTR_OPC_TIMEOUT,        
	                           0, maxTime);

	  error = PLP_WaitForOPCCallback (vi, Ivi_IOSession(vi));
...
/*****************************************************************************
 * Function: PLP_DefaultInstrSetup                                               
 * Purpose:  This function sends a default setup to the instrument.  The    
 *           PLP_reset function calls this function.  The 
 *           PLP_IviInit function calls this function when the
 ...
 *
 *****************************************************************************/
static ViStatus PLP_DefaultInstrSetup (ViSession vi)
{
  ViStatus    error = VI_SUCCESS;
...
/*****************************************************************************
 * Function: PLP_CheckStatusCallback                                               
 ...
 *           PLP_CheckStatus utility function.  The 
...
static ViStatus _VI_FUNC PLP_CheckStatusCallback (ViSession vi, ViSession io)
{
  ...
  {     
		//PLP_query_error_query( vi, &Ret, ErrMsg);
...
/*****************************************************************************
 * Function: PLP_WaitForOPCCallback                                               
 ...
 *           PLP_WaitForOPC utility function.  The IVI engine invokes
...
/*- PLP_ATTR_SPECIFIC_DRIVER_REVISION -*/
                                                                  ...
                                                                  const ViConstString cacheValue)
{
  ...
  sprintf (driverRevision, 
           "Driver: PLP %i.%i, Compiler: %s %3.2f, "
           "Components: IVIEngine %.2f, VISA-Spec %.2f",
           PLP_MAJOR_VERSION, PLP_MINOR_VERSION, 
...
/*- PLP_ATTR_INSTRUMENT_FIRMWARE_REVISION -*/

static ViStatus _VI_FUNC PLPAttrFirmwareRevision_ReadCallback (ViSession vi, 
                                                                    ViSession io,
                                                                    ViConstString channelName, 
                                                                    ViAttr attributeId,
                                                                    const ViConstString cacheValue)
...
/*- PLP_ATTR_INSTRUMENT_MANUFACTURER -*/
                                                                          ...
                                                                          const ViConstString cacheValue)
{
  ...
  checkErr( Ivi_GetAttributeViString (vi, "", PLP_ATTR_ID_QUERY_RESPONSE,
                                      0, BUFFER_SIZE, idQ));
...
/*- PLP_ATTR_VOLTAGE_LEVEL -*/
static IviRangeTableEntry attrVoltageLevelRangeTableEntries[] =
	{
		{0.0, 15.00, 0, "0", PLP_VAL_RANGE_1},
		{0.0, 30.00, 0, "1", PLP_VAL_RANGE_2},
		{0.0, 60.00, 0, "2", PLP_VAL_RANGE_3},
		{IVI_RANGE_TABLE_LAST_ENTRY}
	};
...
/*- PLP_ATTR_CURRENT_LIMIT_BEHAVIOR -*/
...
/*=PTP KCS:===============================================================*
  ...
  - Delete the PLPAttrCurrentLimitBehavior_ReadCallback
    and PLPAttrCurrentLimitBehavior_WriteCallback
...
{
	{PLP_VAL_CURRENT_TRIP, 0, 0, "TRP", 0},
	{IVI_RANGE_TABLE_LAST_ENTRY}
};
...
static IviRangeTableEntry attrCurrentLimitRangeTableEntries[] =
	{
		{0.0, 0.500, 0, "", PLP_VAL_RANGE_1},
		{0.0, 3.00, 0, "", PLP_VAL_RANGE_2},
		{IVI_RANGE_TABLE_LAST_ENTRY}
	};
                                                                 ...
                                                                 ViBoolean value)
{
  ViStatus error = VI_SUCCESS;
	...
	PLP_GetAttributeViInt32 (vi, "", PLP_ATTR_NUM_CHANNELS, &Channels);
	if (Channels < 2)
	...
	switch (Ret[0])
	{
			...
			case '1':
				*value = attrConfigRangeTableEntries[1].discreteOrMinValue;
				break;
			case '2':
				*value = attrConfigRangeTableEntries[2].discreteOrMinValue;
				break;
			default:
				*value = attrConfigRangeTableEntries[3].discreteOrMinValue;
				break;
	}
...
static ViStatus PLP_InitAttributes (ViSession vi)
{
	...
	checkErr( Ivi_SetAttributeViInt32 (vi, "", PLP_ATTR_SPECIFIC_DRIVER_MAJOR_VERSION,
	                                   0, PLP_MAJOR_VERSION));
	checkErr( Ivi_SetAttributeViInt32 (vi, "", PLP_ATTR_SPECIFIC_DRIVER_MINOR_VERSION,
	                                   0, PLP_MINOR_VERSION));
	checkErr( Ivi_SetAttrReadCallbackViString (vi, PLP_ATTR_SPECIFIC_DRIVER_REVISION,
	                                           PLPAttrDriverRevision_ReadCallback));
	checkErr( Ivi_SetAttributeViInt32 (vi, "", PLP_ATTR_SPECIFIC_DRIVER_CLASS_SPEC_MAJOR_VERSION,
	                                   0, PLP_CLASS_SPEC_MAJOR_VERSION));
	checkErr( Ivi_SetAttributeViInt32 (vi, "", PLP_ATTR_SPECIFIC_DRIVER_CLASS_SPEC_MINOR_VERSION,
	                                   0, PLP_CLASS_SPEC_MINOR_VERSION));
	checkErr( Ivi_SetAttributeViString (vi, "", PLP_ATTR_IO_SESSION_TYPE,
	                                    0, PLP_IO_SESSION_TYPE));
	checkErr( Ivi_SetAttributeViString (vi, "", PLP_ATTR_SUPPORTED_INSTRUMENT_MODELS,
	                                    0, PLP_SUPPORTED_INSTRUMENT_MODELS));
	checkErr( Ivi_SetAttrReadCallbackViString (vi, PLP_ATTR_INSTRUMENT_FIRMWARE_REVISION,
	                                           PLPAttrFirmwareRevision_ReadCallback));
	checkErr( Ivi_GetAttributeFlags (vi, PLP_ATTR_INSTRUMENT_FIRMWARE_REVISION, &flags));
	checkErr( Ivi_SetAttributeFlags (vi, PLP_ATTR_INSTRUMENT_FIRMWARE_REVISION, 
	                               flags | IVI_VAL_USE_CALLBACKS_FOR_SIMULATION));
	checkErr( Ivi_GetAttributeFlags (vi, PLP_ATTR_INSTRUMENT_MANUFACTURER, &flags));
	checkErr( Ivi_SetAttributeFlags (vi, PLP_ATTR_INSTRUMENT_MANUFACTURER, 
	                               flags | IVI_VAL_USE_CALLBACKS_FOR_SIMULATION));
	checkErr( Ivi_SetAttrReadCallbackViString (vi, PLP_ATTR_INSTRUMENT_MANUFACTURER,
	                                         PLPAttrInstrumentManufacturer_ReadCallback));
	checkErr( Ivi_GetAttributeFlags (vi, PLP_ATTR_INSTRUMENT_MODEL, &flags));
	checkErr( Ivi_SetAttributeFlags (vi, PLP_ATTR_INSTRUMENT_MODEL, 
	                               flags | IVI_VAL_USE_CALLBACKS_FOR_SIMULATION));
	checkErr( Ivi_SetAttrReadCallbackViString (vi, PLP_ATTR_INSTRUMENT_MODEL,
	                                         PLPAttrInstrumentModel_ReadCallback));
	checkErr( Ivi_SetAttributeViString (vi, "", PLP_ATTR_SPECIFIC_DRIVER_VENDOR,
	                                    0, PLP_DRIVER_VENDOR));
	checkErr( Ivi_SetAttributeViString (vi, "", PLP_ATTR_SPECIFIC_DRIVER_DESCRIPTION,
	                                    0, PLP_DRIVER_DESCRIPTION));
	checkErr( Ivi_SetAttributeViAddr (vi, VI_NULL, IVI_ATTR_OPC_CALLBACK, 0,
	                                  PLP_WaitForOPCCallback));
	checkErr( Ivi_SetAttributeViAddr (vi, VI_NULL, IVI_ATTR_CHECK_STATUS_CALLBACK, 0,
	                                  PLP_CheckStatusCallback));
	checkErr( Ivi_SetAttributeViBoolean (vi, VI_NULL, IVI_ATTR_SUPPORTS_WR_BUF_OPER_MODE, 
	                                   0, VI_FALSE));
	checkErr( Ivi_SetAttributeViString (vi, "", PLP_ATTR_GROUP_CAPABILITIES, 0,
	                                  "IviDCPwrBase,"
	                                  "IviDCPwrTrigger,"
	...
	checkErr (Ivi_AddAttributeViBoolean (vi, PLP_ATTR_OUTPUT_ENABLED,
	                                   "PLP_ATTR_OUTPUT_ENABLED", VI_FALSE,
	                                   IVI_VAL_MULTI_CHANNEL, VI_NULL,
	                                   PLPAttrOutputEnabled_WriteCallback));
  
  checkErr( Ivi_AddAttributeViReal64 (vi, PLP_ATTR_VOLTAGE_LEVEL,
                                       "PLP_ATTR_VOLTAGE_LEVEL",
                                       0.0, 
                                       IVI_VAL_MULTI_CHANNEL,
                                       PLPAttrVoltageLevel_ReadCallback,
                                       PLPAttrVoltageLevel_WriteCallback,
                                       &attrVoltageLevelRangeTable, 0));
                                       
	checkErr (Ivi_AddAttributeViBoolean (vi, PLP_ATTR_OVP_ENABLED,
	                                     "PLP_ATTR_OVP_ENABLED", VI_TRUE,
	                                     IVI_VAL_MULTI_CHANNEL, VI_NULL, VI_NULL));
  
	checkErr (Ivi_AddAttributeViReal64 (vi, PLP_ATTR_OVP_LIMIT,
	                                  "PLP_ATTR_OVP_LIMIT", 40.0,
	                                  IVI_VAL_MULTI_CHANNEL,
	                                  PLPAttrOVPLimit_ReadCallback,
	                                  PLPAttrOVPLimit_WriteCallback,
	                                  &attrOVPLimitRangeTable, 0));
  
	checkErr (Ivi_AddAttributeViInt32 (vi, PLP_ATTR_CURRENT_LIMIT_BEHAVIOR,
	                                 "PLP_ATTR_CURRENT_LIMIT_BEHAVIOR",
	                                 PLP_VAL_CURRENT_TRIP,
	                                 IVI_VAL_MULTI_CHANNEL, VI_NULL, VI_NULL,
	                                 &attrCurrentLimitBehaviorRangeTable));
  
  checkErr( Ivi_AddAttributeViReal64 (vi, PLP_ATTR_CURRENT_LIMIT,
                                       "PLP_ATTR_CURRENT_LIMIT",
                                       0.08, 
                                       IVI_VAL_MULTI_CHANNEL,
                                       PLPAttrCurrentLimit_ReadCallback,
                                       PLPAttrCurrentLimit_WriteCallback,
                                       &attrCurrentLimitRangeTable, 0));
  
	checkErr (Ivi_AddAttributeViString (vi, PLP_ATTR_ID_QUERY_RESPONSE,
	                                    "PLP_ATTR_ID_QUERY_RESPONSE",
	                                    "THURLBY THANDAR,PL",
	                                    IVI_VAL_NOT_USER_WRITABLE,
	                                    PLPAttrIdQueryResponse_ReadCallback, VI_NULL));
                                         
	checkErr (Ivi_AddAttributeViInt32 (vi, PLP_ATTR_OPC_TIMEOUT,
	                                   "PLP_ATTR_OPC_TIMEOUT", 5000,
	                                   IVI_VAL_DONT_CHECK_STATUS | IVI_VAL_HIDDEN,
	                                   VI_NULL, VI_NULL, &attrOpcTimeoutRangeTable));
	checkErr (Ivi_AddAttributeViInt32 (vi, PLP_ATTR_RANGE_SETTING,
	                                   "PLP_ATTR_RANGE_SETTING", 0,
	                                   IVI_VAL_MULTI_CHANNEL | IVI_VAL_NEVER_CACHE,
	                                   PLPAttrRangeSetting_ReadCallback,
	                                   PLPAttrRangeSetting_WriteCallback,
	                                   &attrRangeSettingRangeTable));
	checkErr (Ivi_AddAttributeViReal64 (vi, PLP_ATTR_OCP_LIMIT,
	                                  "PLP_ATTR_OCP_LIMIT", 5.5,
	                                  IVI_VAL_MULTI_CHANNEL,
	                                  PLPAttrOCPLimit_ReadCallback,
	                                  PLPAttrOCPLimit_WriteCallback,
	                                  &attrOCPLimitRangeTable, 0));
	checkErr (Ivi_AddAttributeViBoolean (vi, PLP_ATTR_IFLOCK, "PLP_ATTR_IFLOCK",
	                                     VI_FALSE, 0, PLPAttrIflock_ReadCallback,
	                                     PLPAttrIflock_WriteCallback));
	checkErr (Ivi_AddAttributeViReal64 (vi, PLP_ATTR_VOLTAGE_STEP_SIZE,
	                                    "PLP_ATTR_VOLTAGE_STEP_SIZE", 0.01,
	                                    IVI_VAL_MULTI_CHANNEL,
	                                    PLPAttrVoltageStepSize_ReadCallback,
	                                    PLPAttrVoltageStepSize_WriteCallback,
	                                    &attrVoltageLevelRangeTable, 0));
	checkErr (Ivi_AddAttributeViReal64 (vi, PLP_ATTR_CURRENT_STEP_SIZE,
	                                    "PLP_ATTR_CURRENT_STEP_SIZE", 0.001,
	                                    IVI_VAL_MULTI_CHANNEL,
	                                    PLPAttrCurrentStepSize_ReadCallback,
	                                    PLPAttrCurrentStepSize_WriteCallback,
	                                    &attrCurrentLimitRangeTable, 0));
	checkErr (Ivi_AddAttributeViInt32 (vi, PLP_ATTR_LIMIT_STATUS_REGISTER_1,
	                                   "PLP_ATTR_LIMIT_STATUS_REGISTER_1", 0,
	                                   IVI_VAL_NOT_USER_WRITABLE | IVI_VAL_MULTI_CHANNEL,
	                                   PLPAttrLimitStatusRegister1_ReadCallback,
	                                   VI_NULL, &attrStatusRegisterRangeTable));
	checkErr (Ivi_AddAttributeViInt32 (vi, PLP_ATTR_LIMIT_STATUS_ENABLE_REGISTER_1,
	                                   "PLP_ATTR_LIMIT_STATUS_ENABLE_REGISTER_1", 0,
	                                   IVI_VAL_MULTI_CHANNEL,
	                                   PLPAttrLimitStatusEnableRegister1_ReadCallback,
	                                   PLPAttrLimitStatusEnableRegister1_WriteCallback,
	                                   &attrStatusRegisterRangeTable));
	checkErr (Ivi_AddAttributeViInt32 (vi, PLP_ATTR_STANDARD_EVENT_ENABLE_REGISTER,
	                                   "PLP_ATTR_STANDARD_EVENT_ENABLE_REGISTER", 0,
	                                   0,
	                                   PLPAttrStandardEventEnableRegister_ReadCallback,
	                                   PLPAttrStandardEventEnableRegister_WriteCallback,
	                                   &attrStatusRegisterRangeTable));
	checkErr (Ivi_AddAttributeViInt32 (vi, PLP_ATTR_STANDARD_EVENT_STATUS_REGISTER,
	                                   "PLP_ATTR_STANDARD_EVENT_STATUS_REGISTER", 0,
	                                   IVI_VAL_NOT_USER_WRITABLE,
	                                   PLPAttrStandardEventStatusRegister_ReadCallback,
	                                   VI_NULL, &attrStatusRegisterRangeTable));
	checkErr (Ivi_AddAttributeViInt32 (vi, PLP_ATTR_IST_LOCAL_MESSAGE,
	                                   "PLP_ATTR_IST_LOCAL_MESSAGE", 0,
	                                   IVI_VAL_NOT_USER_WRITABLE,
	                                   PLPAttrIstLocalMessage_ReadCallback, VI_NULL,
	                                   &attrStatusRegisterRangeTable));
	checkErr (Ivi_AddAttributeViInt32 (vi, PLP_ATTR_OPERATION_COMPLETE_STATUS,
	                                   "PLP_ATTR_OPERATION_COMPLETE_STATUS", 0, 0,
	                                   PLPAttrOperationCompleteStatus_ReadCallback,
	                                   PLPAttrOperationCompleteStatus_WriteCallback,
	                                   &attrStatusRegisterRangeTable));
	checkErr (Ivi_AddAttributeViInt32 (vi, PLP_ATTR_PARALLEL_POLE_ENABLE_REGISTER,
	                                   "PLP_ATTR_PARALLEL_POLE_ENABLE_REGISTER", 0,
	                                   0,
	                                   PLPAttrParallelPoleEnableRegister_ReadCallback,
	                                   PLPAttrParallelPoleEnableRegister_WriteCallback,
	                                   &attrStatusRegisterRangeTable));
	checkErr (Ivi_AddAttributeViInt32 (vi, PLP_ATTR_SERVICE_REQUEST_ENABLE_REGISTER,
	                                   "PLP_ATTR_SERVICE_REQUEST_ENABLE_REGISTER",
	                                   0, 0,
	                                   PLPAttrServiceRequestEnableRegister_ReadCallback,
	                                   PLPAttrServiceRequestEnableRegister_WriteCallback,
	                                   &attrStatusRegisterRangeTable));
	checkErr (Ivi_AddAttributeViInt32 (vi, PLP_ATTR_STATUS_BYTE_REGISTER,
	                                   "PLP_ATTR_STATUS_BYTE_REGISTER", 0,
	                                   IVI_VAL_NOT_USER_WRITABLE,
	                                   PLPAttrStatusByteRegister_ReadCallback,
	                                   VI_NULL, &attrStatusRegisterRangeTable));
	checkErr (Ivi_AddAttributeViInt32 (vi, PLP_ATTR_ADDRESS, "PLP_ATTR_ADDRESS", 0,
	                                   IVI_VAL_NOT_USER_WRITABLE,
	                                   PLPAttrAddress_ReadCallback, VI_NULL,
	                                   &attrAddressRangeTable));
	checkErr (Ivi_AddAttributeViBoolean (vi, PLP_ATTR_VERIFY_VOLTAGE,
	                                     "PLP_ATTR_VERIFY_VOLTAGE", VI_FALSE,
	                                     IVI_VAL_USE_CALLBACKS_FOR_SIMULATION,
	                                     PLPAttrVerifyVoltage_ReadCallback,
	                                     PLPAttrVerifyVoltage_WriteCallback));
	checkErr (Ivi_AddAttributeViBoolean (vi, PLP_ATTR_OUTPUT_ENABLED_ALL,
	                                   "PLP_ATTR_OUTPUT_ENABLED_ALL", VI_FALSE, 0,
	                                   VI_NULL,
	                                   PLPAttrOutputEnabledAll_WriteCallback));
	checkErr (Ivi_AddAttributeViInt32 (vi, PLP_ATTR_LIMIT_STATUS_REGISTER_2,
	                                   "PLP_ATTR_LIMIT_STATUS_REGISTER_2", 0,
	                                   IVI_VAL_NOT_USER_WRITABLE | IVI_VAL_MULTI_CHANNEL,
	                                   PLPAttrLimitStatusRegister2_ReadCallback,
	                                   VI_NULL, &attrStatusRegisterRangeTable));
	checkErr (Ivi_AddAttributeViInt32 (vi, PLP_ATTR_LIMIT_STATUS_ENABLE_REGISTER_2,
	                                   "PLP_ATTR_LIMIT_STATUS_ENABLE_REGISTER_2", 0,
	                                   IVI_VAL_MULTI_CHANNEL,
	                                   PLPAttrLimitStatusEnableRegister2_ReadCallback,
	                                   PLPAttrLimitStatusEnableRegister2_WriteCallback,
	                                   &attrStatusRegisterRangeTable));
	checkErr (Ivi_AddAttributeViInt32 (vi, PLP_ATTR_CONFIG, "PLP_ATTR_CONFIG", 1,
	                                   IVI_VAL_NOT_USER_WRITABLE | IVI_VAL_NEVER_CACHE,
	                                   PLPAttrConfig_ReadCallback, VI_NULL,
	                                   &attrConfigRangeTable));
	checkErr (Ivi_AddAttributeViBoolean (vi, PLP_ATTR_DAMPING, "PLP_ATTR_DAMPING",
	                                     VI_FALSE,
	                                     IVI_VAL_NOT_USER_READABLE | IVI_VAL_MULTI_CHANNEL,
	                                     VI_NULL, PLPAttrDamping_WriteCallback));
	checkErr (Ivi_AddAttributeViReal64 (vi, PLP_ATTR_RATIO, "PLP_ATTR_RATIO", 50,
	                                    IVI_VAL_MULTI_CHANNEL,
	                                    PLPAttrRatio_ReadCallback,
	                                    PLPAttrRatio_WriteCallback,
	                                    &attrRatioRangeTable, 0));
                                   
	/*- Setup attribute invalidations -----------------------------------*/            

	checkErr (Ivi_AddAttributeInvalidation (vi, PLP_ATTR_VERIFY_VOLTAGE,
	                                      PLP_ATTR_VOLTAGE_LEVEL, VI_TRUE));
	checkErr (Ivi_AddAttributeInvalidation (vi, PLP_ATTR_RANGE_SETTING,
	                                        PLP_ATTR_VOLTAGE_LEVEL, VI_TRUE));
	checkErr (Ivi_AddAttributeInvalidation (vi, PLP_ATTR_RANGE_SETTING,
	                                        PLP_ATTR_CURRENT_LIMIT, VI_TRUE));
	Error:
	return error;
}
...
static ViStatus PLP_InitRangeTables (ViSession vi)
{
	...
	if (error == VI_SUCCESS)
	{
 	  switch (PSUModel)
		{
			case PL155:
				attrVoltageLevelRangeTableEntries[0].maxValue = 15.00;
				attrVoltageLevelRangeTableEntries[1].maxValue = 15.00;
				attrVoltageLevelRangeTableEntries[2].maxValue = 15.00;
				attrCurrentLimitRangeTableEntries[0].maxValue = 0.5;
				attrCurrentLimitRangeTableEntries[1].maxValue = 5.0;
				attrOVPLimitRangeTableEntries[0].maxValue = 15 * 1.05;
				attrOCPLimitRangeTableEntries[0].maxValue = 5 * 1.05;
				break;
			case PL303:
				attrVoltageLevelRangeTableEntries[0].maxValue = 30.00;
				attrVoltageLevelRangeTableEntries[1].maxValue = 30.00;
				attrVoltageLevelRangeTableEntries[2].maxValue = 30.00;
				attrCurrentLimitRangeTableEntries[0].maxValue = 0.5;
				attrCurrentLimitRangeTableEntries[1].maxValue = 3.0;
				attrOVPLimitRangeTableEntries[0].maxValue = 30 * 1.05;
				attrOCPLimitRangeTableEntries[0].maxValue = 3 * 1.05;      
				break;
			case PL601:
				attrVoltageLevelRangeTableEntries[0].maxValue = 60.00;
				attrVoltageLevelRangeTableEntries[1].maxValue = 60.00;
				attrVoltageLevelRangeTableEntries[2].maxValue = 60.00;
				attrCurrentLimitRangeTableEntries[0].maxValue = 0.5;
				attrCurrentLimitRangeTableEntries[1].maxValue = 1.5;
				attrOVPLimitRangeTableEntries[0].maxValue = 60 * 1.05;  
				attrOCPLimitRangeTableEntries[0].maxValue = 1.5 * 1.05;      
				break;
			...
			case XEL303DP:
				attrVoltageLevelRangeTableEntries[0].maxValue = 30.00;
				attrVoltageLevelRangeTableEntries[1].maxValue = 30.00;
				attrVoltageLevelRangeTableEntries[2].maxValue = 20.00;	  /* Why is this 20 ? Kevins code has 20   */
				attrCurrentLimitRangeTableEntries[0].maxValue = 1.0;
				attrCurrentLimitRangeTableEntries[1].maxValue = 6.0;
				attrOVPLimitRangeTableEntries[0].maxValue = 30 * 1.05;
				attrOCPLimitRangeTableEntries[0].maxValue = 3 * 1.05;     
				break;	
				
		    case PLH120P:
				attrVoltageLevelRangeTableEntries[0].maxValue = 120.00;
				attrVoltageLevelRangeTableEntries[1].maxValue = 120.00;
				attrVoltageLevelRangeTableEntries[2].maxValue = 120.00;		
				attrCurrentLimitRangeTableEntries[0].maxValue = 0.075;
				attrCurrentLimitRangeTableEntries[1].maxValue = 0.75;
				attrOVPLimitRangeTableEntries[0].maxValue = 120 * 1.05;  
				attrOCPLimitRangeTableEntries[0].maxValue = 0.75 * 1.05;      
				break;
				
			case PLH250P:
				attrVoltageLevelRangeTableEntries[0].maxValue = 250.00;
				attrVoltageLevelRangeTableEntries[1].maxValue = 250.00;
				attrVoltageLevelRangeTableEntries[2].maxValue = 250.00;		
				attrCurrentLimitRangeTableEntries[0].maxValue = 0.075;
				attrCurrentLimitRangeTableEntries[1].maxValue = 0.375;
				attrOVPLimitRangeTableEntries[0].maxValue = 250 * 1.05; 
				attrOCPLimitRangeTableEntries[0].maxValue = 0.375 * 1.05;      
				break;
			case XEL120_075P:
				attrVoltageLevelRangeTableEntries[0].maxValue = 120.00;
				attrVoltageLevelRangeTableEntries[1].maxValue = 120.00;
