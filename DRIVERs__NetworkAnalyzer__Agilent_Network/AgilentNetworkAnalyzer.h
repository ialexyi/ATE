...
#define		NETWORK_ANALYZER_SWEEP_TYPE_HOLD	1
#define		NETWORK_ANALYZER_SWEEP_TYPE_CONT	2
#define		NETWORK_ANALYZER_SWEEP_TYPE_GROUP	3
#define		NETWORK_ANALYZER_SWEEP_TYPE_SINGLE	4		
