...
int main (int argc, char *argv[])
{
	...
	if ((panelHandle = LoadPanel (0, "RIO_Control_Editor.uir", PANEL)) < 0)
		return -1;
...
void CVICALLBACK clbMenuOpenFile (int menuBar, int menuItem, void *callbackData, int panel)
{
	...
	if ( FileSelectPopup ("", "*.riocnf", "*.riocnf", "Load", VAL_LOAD_BUTTON, 0, 1, 1, 1, szFilePath ))
	{
...
void CVICALLBACK clbMenuSaveFile (int menuBar, int menuItem, void *callbackData, int panel)
{
	...
	if ( FileSelectPopup ("", "*.riocnf", "*.riocnf", "Save", VAL_SAVE_BUTTON, 0, 1, 1, 1, szFilePath ))
	{
